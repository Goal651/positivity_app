            ...
            <div className="flex mx-20 gap-x-20 items-center justify-center">
                <div className="flex flex-col gap-y-5 justify-center">
                    ...
                    >
                        ...
                        <img
                            className="absolute -top-10 left-44 w-44"
                            src="/inspiringCover1.png"
                            alt="" />
                    </div>
                    ...
                    <div className="flex">
                        <span style={{ color: '#FF8500' }}
                            className="font-semibold"> Find more</span>
                        <span>
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19.2852 12.1176L5.28933 12.4569M19.2852 12.1176L15.3833 16.2134M19.2852 12.1176L15.1895 8.21572" stroke="#FF8500" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </span>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-y-5 justify-center">
                    ...
                    >
                        <img
                            ...
                            alt=""
                            className="object-cover w-full  z-5 " />
                        <img
                            className="absolute top-68 left-36 "
                            src="/inspiringCover3.png"
                            alt="" />
                    </div>
                    <div className="text-black font-semibold w-52">
                        Choose your color gradient and let the positive vibes shine through!
